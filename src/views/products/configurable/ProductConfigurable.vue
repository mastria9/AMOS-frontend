<template>
    <div id="root" class="root hd--expanded hd--sticky mn--sticky" :class="{ 'mn--max' : !collapse, 'mn--min' : collapse, }">
          ...
          <div class="content__header content__boxed overlapping">
              <div class="content__wrap">
                  ...
                  <h1 class="page-title mb-2">Prodotto Configurabile</h1>
                ...
                <div class="content__wrap">
                    ...
                    <div class="row p-2 bg-light">
                        <div class="col-4">
                            ...
                            <div class="col-9 m-auto mb-0 ms-0">
                        ...
                        <div class="col-4">
                            <div class="row col-12 mb-4">
                                <div class="col-3 mb-0 m-auto d-md-flex justify-content-md-start">
                                    <h5>Configurazione</h5>
                                </div>
                                <div class="col-9">
                                    <button class="m-auto mt-0 justify-content-md-end btn btn-warning" v-on:click="this.openAssociation()">Cambia configurazione</button>
                                </div>
                            </div>
                            <div class="row col-12">
                                <div class="col-4">
                                    <b>Prodotti</b>
                                    <ul class="p-0 m-0" v-if="'products' in this.product" v-for="(obj,id) in product.products" :key="id">
                                        <li>
                                            <a :href="'/product/simple/?id='+obj.id+'&marketplace='+this.marketplace.id+'&company='+this.company.id">{{obj.sku}}</a><br/>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-2">
                                    <b>Varianti</b>
                                    <ul class="p-0 m-0" v-if="'variations' in this.product" v-for="(obj,id) in product.variations" :key="id">
                                        <li>
                                            {{obj.description}}<br/>
                                        </li>
                                    </ul>
                      ...
                      <div class="col-4 row">
                          <div class="col-12 d-md-flex mt-0 mb-auto justify-content-md-end">
                              <a :href="'/products/configurable/?company='+this.company.id+'&marketplace='+this.marketplace.id" class="btn btn-primary">Tutti i prodotti</a>
                          </div>
                          <div class="col-12 d-md-flex justify-content-md-end justify-content-md-end mb-0 mt-auto">
                              <button class="btn btn-outline-success" v-on:click="saveProduct()">Salva bozza</button>
                          </div>
                          
                      </div>
                  </div>
                  <div class="row mt-3 mb-3" v-if="this.association">
                ...
                <!-- PRODOTTI ESISTENTI -->
                  ...
                  <div class="card col-12 m-auto p-4">
                    <div class="card-header">
                      <h6 class="card-title">Stai modificando il prodotto configurabile (prodotti sempici/variazioni)</h6>
                      <div class="card-category">Categoria {{this.category.title}}</div> 
                    </div>
                    ...
                    <div class="card-footer row">
                      <div class="col-6 d-md-flex justify-content-md-end">
                        <button v-if="this.configurable.variations_selected && this.configurable.childs_selected" class="btn btn-warning" v-on:click="this.updateConfigurable()">Aggiorna</button>
                      </div>
                    </div>
                  </div>
                <!-- CONFIGURABILE -->
  ...
  export default{
      ...
      methods:{
        ...
        async init(){
            this.getCompanies().then(this.getMarketplaces).then(this.getProduct).then(this.getProductCategory)
        },
        async getCompanies(){
            try{
        ...
        async getProductCategory(){
            const res = await this.axios.get("/api/products/categories/?company="+this.company.id+"&marketplace="+this.marketplace.id+"&configurable="+this.$route.query.id).then((res)=>{
                if(res.data.results.length>0){
          ...
          async getProduct(){
                  ...
                  const res = await this.axios.get("/api/products/configurable/"+this.$route.query.id+"/?company="+this.company.id+"&marketplace="+this.marketplace.id).then((res)=>{
                          ...
                          this.product.products=res.data.products
                          this.product.variations=res.data.variations
          ...
          saveProduct(){
              ...
              this.axios.put("/api/products/configurable/"+this.product.id+"/?company="+this.company.id+"&marketplace="+this.marketplace.id,this.product).then((res)=>{
          ...
          copyToProducts(){
              ...
              this.axios.put("/api/copy/to/configurable/?company="+this.company.id+"&marketplace="+this.marketplace.id+"&product="+this.product.id,data).then((res)=>{
          ...
          copyFromProduct(){
              ...
              this.axios.put("/api/copy/from/configurable/?company="+this.company.id+"&marketplace="+this.marketplace.id+"&product="+this.product.id,data).then((res)=>{
                  this.toast.success("Copia effettuata");                
              }).catch((error)=>{
                  this.toast.error(error.response.data.detail)
              })
    ...
    async openAssociation(){
        this.getConfigurableCombinations(true)
    ...
    getConfigurableCombinations(reset) {
      ...
      if (reset) {
        this.childs = [];
        this.variations = [];
        for(var i=0;i<this.product.products.length;i++){
            let obj={}
            obj["sku"]=this.product.products[i].sku
            obj["id"]=this.product.products[i].id
            obj["item"]=this.product.products[i].item
            this.childs.push(obj)
        }
        for(var i=0;i<this.product.variations.length;i++){
            let obj={}
            obj["description"]=this.product.variations[i].description
            obj["type"]=this.product.variations[i].type
            obj["name"]=this.product.variations[i].name
            obj["id"]=this.product.variations[i].id
    ...
    async updateConfigurable(){
      ...
      await this.axios.put("/api/products/configurable/"+this.product.id+"/?company="+this.company.id+"&marketplace="+this.marketplace.id,configurable).then((res)=>{
        this.toast.success("Prodotto configurabile aggiornato")
        this.$router.go()
      }).catch((error)=>{
        
        this.toast.error("Errore nell'aggiornare il prodotto configurabile")
      })
