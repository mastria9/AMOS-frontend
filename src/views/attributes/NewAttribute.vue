 ...
 <div id="root" class="root hd--expanded hd--sticky mn--sticky" :class="{ 'mn--max' : !collapse, 'mn--min' : collapse, }">
        ...
        <div class="content__header content__boxed overlapping">
            <div class="content__wrap">
                    ...
                    <h2 class="h5">Crea un attributo</h2>
                    <p></p>
  ...
  <Footer/>
        ...
        <Sidebar :collapse.sync="collapse" :company.sync="company" :companies.sync="companies" @update:company="(index) => changeCompany(index)" parent="dashbattributesoard" @update:collapse="(collapse=false)"/>
    </div>
...
methods:{
      ...
      create(){
          ...
          this.axios.post("/api/products/custom_attributes/?company="+this.company.id,this.attribute).then((res)=>{
