    ...
    <div class="content__boxed">
                        ...
                        <div class="col-xl-7 mb-3 mb-xl-0">
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body py-0" style="height: 250px; max-height: 275px">
                                    <canvas id="_dm-networkChart" style="display: block; box-sizing: border-box; height: 253.333px; width: 546.667px;" width="410" height="190"></canvas>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="card bg-success text-white overflow-hidden mb-3">
                                        ...
                                        <div class="py-0" style="height: 70px; margin: 0 -5px -5px;">
                                            <canvas id="_dm-hddChart" style="display: block; box-sizing: border-box; height: 69.3333px; width: 208px;" width="156" height="52"></canvas>
                                        </div>
                                        <!-- END : Area Chart -->
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="card bg-info text-white overflow-hidden mb-3">
                                        ...
                                        <!-- Line Chart -->
                                        <div class="py-0" style="height: 70px; margin: 0 -5px -5px;">
                                            <canvas id="_dm-earningChart" style="display: block; box-sizing: border-box; height: 69.3333px; width: 208px;" width="156" height="52"></canvas>
                                        </div>
                                        <!-- END : Line Chart -->
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="card bg-purple text-white overflow-hidden mb-3">
                                        ...
                                        <div class="py-0" style="height: 70px">
                                            <canvas id="_dm-salesChart" style="display: block; box-sizing: border-box; height: 69.3333px; width: 198.667px;" width="149" height="52"></canvas>
                                        </div>
                                        <!-- END : Bar Chart -->
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="card bg-warning text-white overflow-hidden mb-3">
                                        ...
                                        <div class="py-0 pb-2" style="height: 70px">
                                            <canvas id="_dm-taskChart" style="display: block; box-sizing: border-box; height: 61.3333px; width: 198.667px;" width="149" height="46"></canvas>
                                        </div>
            ...
            <footer class="content__boxed mt-auto">
                <div class="content__wrap py-3 py-md-1 d-flex flex-column flex-md-row align-items-md-center">
                    <div class="text-nowrap mb-4 mb-md-0">Copyright © 2022 <a href="#" class="ms-1 btn-link fw-bold">My Company</a></div>
