...
*/
    ...
    function we(t, e, i) {
        ...
        (t.currentDevicePixelRatio !== n || a.height !== o || a.width !== s) && (t.currentDevicePixelRatio = n,
        a.height = o,
        a.width = s,
    ...
    function Ce(t, e, i, n) {
        const o = [];
        if (!Gt(e, t.chartArea, t._minPadding))
            return o;
    ...
    function Ve(t, e) {
        ...
        n && !("" + n).match(Re) && (console.warn('Invalid font style specified: "' + n + '"'),
        n = "");
        const o = {
    ...
    function Ue(t, e) {
        ...
        a = t.length; s < a; ++s) {
            ...
            r.horizontal ? (r.width = c ? c * n : a && e.availableWidth,
            r.height = o) : (r.width = n,
            r.height = c ? c * o : a && e.availableHeight)
        }
        return i
    }
    function Xe(t, e, i, n) {
    ...
    function Je(t, e, i, n) {
        ...
        for (const r of t) {
            ...
            if (r.horizontal) {
                ...
                t.fullSize ? Qe(t, o.left, a, i.outerWidth - o.right - o.left, s) : Qe(t, e.left + l.placed, a, n, s),
                l.start = a,
                l.placed += n,
                a = t.bottom
            } else {
                ...
                t.fullSize ? Qe(t, s, o.top, a, i.outerHeight - o.bottom - o.top) : Qe(t, s, e.top + l.placed, a, n),
                l.start = s,
                l.placed += n,
                s = t.right
            }
            ...
            const o = Be(t.options.layout.padding)
              ...
              , r = function(t) {
                const e = function(t) {
                    ...
                    n = (t || []).length; i < n; ++i)
                        o = t[i],
                        ({position: s, options: {stack: a, stackWeight: r=1}} = o),
                        e.push({
                            index: i,
                            box: o,
                            pos: s,
    ...
    function ei(t, e=[""], i=t, n, o=(()=>t[0])) {
        ...
        return new Proxy(s,{
            ...
            ownKeys: t=>fi(t),
            set: (t,e,i)=>((t._storage || (t._storage = o()))[e] = i,
            delete t[e],
            delete t._keys,
            !0)
        })
    ...
    function hi(t, e, i, n) {
        ...
        r.add(n);
        let l = di(r, a, i, s || i);
        return null !== l && ((!ht(s) || s === i || (l = di(r, a, s, l),
        null !== l)) && ei(Array.from(r), [""], o, s, (()=>function(t, e, i) {
    ...
    function bi(t, e="x") {
        ...
        !function(t, e, i) {
            ...
            for (let h = 0; h < n - 1; ++h)
                l = c,
                c = pi(t, h + 1),
                l && c && (At(e[h], 0, gi) ? i[h] = i[h + 1] = 0 : (o = i[h] / e[h],
                s = i[h + 1] / e[h],
    ...
    function yi(t, e, i, n, o) {
        ...
        e.capBezierPoints && function(t, e) {
            ...
            n = t.length; i < n; ++i)
                ...
                r = i < n - 1 && Gt(t[i + 1], e),
                s && (o = t[i],
                a && (o.cp1x = _i(o.cp1x, e.left, e.right),
                o.cp1y = _i(o.cp1y, e.top, e.bottom)),
                r && (o.cp2x = _i(o.cp2x, e.left, e.right),
    ...
    function Ji(t, i, n) {
        ...
        return r.observe(s),
        function(t, e) {
            Gi.size || window.addEventListener("resize", Qi),
            Gi.set(t, e)
        }(t, a),
        r
    }
    function tn(t, e, i) {
        ...
        "resize" === e && function(t) {
            Gi.delete(t),
            Gi.size || window.removeEventListener("resize", Qi)
        }(t)
    }
    function en(t, i, n) {
        const o = t.canvas
    ...
    class hn {
        ...
        _createAnimations(t, e) {
            ...
            for (r = s.length - 1; r >= 0; --r) {
                ...
                d && d.duration ? (o[l] = h = new ln(d,t,l,c),
                n.push(h)) : t[l] = c
            }
            return n
        }
    ...
    class wn {
        ...
        updateIndex(t) {
            this.index !== t && _n(this._cachedMeta),
            this.index = t
        }
        linkScales() {
            const t = this
        ...
        updateRangeFromParsed(t, e, i, n) {
            ...
            s = fn(n, o, this._cachedMeta.index, {
                all: !0
            })),
            t.min = Math.min(t.min, s),
            t.max = Math.max(t.max, s)
        ...
        _resyncElements(t) {
            ...
            for (const [t,i,n] of e._syncList)
                e[t](i, n);
            e._syncList = [];
            const o = n.length
              , s = i.length
              , a = Math.min(s, o);
            a && e.parse(0, a),
            s > o ? e._insertElements(o, s - o, t) : s < o && e._removeElements(s, o - s)
        }
    ...
    function Pn(t, e) {
        ...
        if (s > 0) {
            ...
            for (Dn(e, l, c, $(n) ? 0 : a - n, a),
            t = 0,
            i = s - 1; t < i; t++)
                Dn(e, l, c, o[t], o[t + 1]);
            return Dn(e, l, c, r, $(n) ? e.length : r + n),
            l
        }
        return Dn(e, l, c),
        l
    ...
    class En extends Mn {
        ...
        update(t, e, i) {
            ...
            o.display && (o.autoSkip || "auto" === o.source) && (n.ticks = Pn(n, n.ticks),
            n._labelSizes = null),
        ...
        calculateLabelRotation() {
            ...
            r = t.maxHeight - An(e.grid) - i.padding - Ln(e.title, t.chart.options.font),
            l = Math.sqrt(d * d + u * u),
            c = It(Math.min(Math.asin(Ht((h.highest.height + 6) / a, -1, 1)), Math.asin(Ht(r / l, -1, 1)) - Math.asin(Ht(u / l, -1, 1)))),
        ...
        fit() {
            ...
            if (a) {
                ...
                e.height = An(s) + a) : (e.height = t.maxHeight,
                e.width = An(s) + a),
        ...
        _convertTicksToLabels(t) {
            const e = this;
            let i, n;
            for (e.beforeTickToLabelConversion(),
            e.generateTickLabels(t),
            i = 0,
            n = t.length; i < n; i++)
                $(t[i].label) && (t.splice(i, 1),
                n--,
                i--);
            ...
            for (a = 0; a < e; ++a) {
                ...
                $(c) || Y(c)) {
                    if (Y(c))
                        ...
                        l = c.length; r < l; ++r)
                            m = c[r],
                            $(m) || Y(m) || (g = Yt(i, u.data, u.gc, g, m),
                            p += f)
                } else
                    g = Yt(i, u.data, u.gc, g, c),
                    p = f;
                o.push(g),
                s.push(p),
                x = Math.max(g, x),
        ...
        _computeLabelItems(t) {
            ...
            b = r.length; x < b; ++x) {
                ...
                let u;
                if (a ? (v = k,
                C = "top" === o ? "near" === c || 0 !== p ? -D * P + P / 2 : "center" === c ? -T.highest.height / 2 - i * P + P : -T.highest.height + P / 2 : "near" === c || 0 !== p ? P / 2 : "center" === c ? T.highest.height / 2 - i * P : T.highest.height - D * P,
                d && (C *= -1)) : (w = k,
                C = (1 - D) * P / 2),
                t.showLabelBackdrop) {
        ...
        drawBorder() {
            ...
            const a = n.setContext(t.getContext(0)).lineWidth
              , r = t._borderValue;
            let l, c, h, d;
            t.isHorizontal() ? (l = Xt(e, t.left, s) - s / 2,
            c = Xt(e, t.right, a) + a / 2,
            h = d = r) : (h = Xt(e, t.top, s) - s / 2,
        ...
        drawLabels(t) {
            ...
            a = o.length; s < a; ++s) {
                const t = o[s]
                  , e = t.font
                  , n = t.label;
                t.backdrop && (i.fillStyle = t.backdrop.color,
                i.fillRect(t.backdrop.left, t.backdrop.top, t.backdrop.width, t.backdrop.height)),
    ...
    class In {
        ...
        unregister(t) {
            const e = this.items
              ...
              , n = this.scope;
            i in e && delete e[i],
            n && i in xt[n] && (delete xt[n][i],
            this.override && delete ft[i])
        }
    }
    var zn = new class {
        constructor() {
    ...
    class Fn {
        ...
        notify(t, e, i, n) {
            const o = this;
            "beforeInit" === e && (o._init = o._createDescriptors(t, !0),
            o._notify(o._init, t, "install"));
            const s = n ? o._descriptors(t).filter(n) : o._descriptors(t)
              , a = o._notify(s, t, e, i);
            return "destroy" === e && (o._notify(s, t, "stop"),
    ...
    class qn {
        ...
        datasetAnimationScopeKeys(t, e) {
            return Un(`${t}.transition.${e}`, (()=>[[`datasets.${t}.transitions.${e}`, `transitions.${e}`], [`datasets.${t}`, ""]]))
        }
        datasetElementScopeKeys(t, e) {
            return Un(`${t}-${e}`, (()=>[[`datasets.${t}.elements.${e}`, `datasets.${t}`, `elements.${e}`, ""]]))
        }
        pluginScopeKeys(t) {
            const e = t.id;
    ...
    function eo(t) {
        return ue() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]),
    ...
    class oo {
        constructor(t, e) {
            const n = this
              ...
              , r = no(s);
            if (r)
                throw new Error("Canvas is already in use. Chart with ID '" + r.id + "' must be destroyed before the canvas can be reused.");
        ...
        clear() {
            return qt(this.canvas, this.ctx),
            this
        }
        stop() {
            return a.stop(this),
        ...
        _resize(t, e) {
            ...
            we(i, r, !0) && (i.notifyPlugins("resize", {
                size: a
            }),
            Q(n.onResize, [i, a], i),
        ...
        update(t) {
            ...
            if (ut(o, s) && !!this._responsiveListeners === e.options.responsive || (e.unbindEvents(),
            e.bindEvents()),
            ...
            for (let t = 0, i = e.data.datasets.length; t < i; t++) {
                const {controller: i} = e.getDatasetMeta(t)
                  , o = !n && -1 === a.indexOf(i);
                i.buildOrUpdateElements(o),
                r = Math.max(+i.getMaxOverflow(), r)
            }
            e._minPadding = r,
            e._updateLayout(r),
            n || J(a, (t=>{
        ...
        _updateVisibility(t, e, i) {
            ...
            ht(e) ? (s.data[e].hidden = !i,
            n.update()) : (n.setDatasetVisibility(t, i),
            a.update(s, {
                visible: i
            }),
        ...
        _handleEvent(t, e) {
            ...
            i._lastEvent = null,
            Gt(t, i.chartArea, i._minPadding) && (Q(o.onHover, [t, r, i], i),
            "mouseup" !== t.type && "click" !== t.type && "contextmenu" !== t.type || Q(o.onClick, [t, r, i], i)),
            l = !tt(r, n),
            (l || e) && (i._active = r,
    ...
    function ho(t) {
        ...
        const r = ()=>{
            32767 !== o && -32768 !== o && (ht(s) && (a = Math.min(a, Math.abs(o - s) || a)),
            s = o)
        }
        ;
        for (i = 0,
    ...
    function po(t, e, i, n) {
        ...
        "middle" === o && i && (t.enableBorderRadius = !0,
        (i._top || 0) === n ? o = c : (i._bottom || 0) === n ? o = h : (s[mo(h, a, r, l)] = !0,
        o = c)),
        s[mo(o, a, r, l)] = !0,
        t.borderSkipped = s
    }
    function mo(t, e, i, n) {
        var o, s, a;
        return n ? (a = i,
        t = xo(t = (o = t) === (s = e) ? a : o === a ? s : o, i, e)) : t = xo(t, e, i),
        t
    }
    function xo(t, e, i) {
    ...
    class bo extends wn {
        ...
        updateElements(t, e, i, n) {
            ...
            for (let d = e; d < e + i; d++) {
                ...
                f && (m.options = u || o.resolveDataElementOptions(d, t[d].active ? "active" : n)),
        ...
        _calculateBarValuePixels(t) {
            const e = this
              ...
              , l = r._custom
              , c = go(l);
            let h, d, u = r[i.axis], f = 0, g = n ? e.applyStack(i, r, n) : u;
            g !== u && (f = g - u,
            g = u),
            c && (u = l.barStart,
            ...
            if (h = e.chart.getDataVisibility(t) ? i.getPixelForValue(f + g) : m,
            d = h - m,
            Math.abs(d) < s && (d = function(t, e, i) {
    ...
    class _o extends wn {
        ...
        updateElements(t, e, i, n) {
            ...
            for (let l = e; l < e + i; l++) {
                ...
                h && (c.options = o.resolveDataElementOptions(l, e.active ? "active" : n),
    ...
    class yo extends wn {
        ...
        updateElements(t, e, i, n) {
            ...
            for (x = e; x < e + i; ++x) {
                ...
                m && (a.options = p || o.resolveDataElementOptions(x, i.active ? "active" : n)),
                b += e,
    ...
    class vo extends wn {
        ...
        update(t) {
            ...
            let {start: r, count: l} = function(t, e, i) {
                ...
                if (t._sorted) {
                    ...
                    d && (o = Ht(Math.min(se(r, a.axis, c).lo, i ? n : se(e, l, a.getPixelForValue(c)).lo), 0, n - 1)),
                    s = u ? Ht(Math.max(se(r, a.axis, h).hi + 1, i ? 0 : se(e, l, a.getPixelForValue(h)).hi + 1), o, n) - o : n - o
                }
                return {
                    start: o,
                    count: s
        ...
        updateElements(t, e, i, n) {
            ...
            for (let c = e; c < e + i; ++c) {
                ...
                g.parsed = i,
                d && (g.options = h || o.resolveDataElementOptions(c, e.active ? "active" : n)),
    ...
    function Do(t, e, i) {
        ...
        t.arc(s, a, r, n - c, i + c),
        l > o ? (c = o / l,
        t.arc(s, a, l, i + c, n - c, !0)) : t.arc(s, a, o, i + Mt, n - Mt),
        t.closePath(),
        t.clip()
    }
    function Co(t, e, i, n) {
    ...
    function Ao(t, e, i, n, o) {
        ...
        s.borderWidth && (a ? (t.lineWidth = 2 * s.borderWidth,
    ...
    class Lo extends Mn {
        ...
        getCenterPoint(t) {
            const {x: e, y: i, startAngle: n, endAngle: o, innerRadius: s, outerRadius: a} = this.getProps(["x", "y", "startAngle", "endAngle", "innerRadius", "outerRadius", "circumference"], t)
    ...
    class jo extends Mn {
        ...
        draw(t, e) {
            const i = this
              , n = i.options;
            i.skip || n.radius < .1 || !Gt(i, e, i.size(n) / 2) || (t.strokeStyle = n.borderColor,
        ...
        beforeElementsUpdate: (t,e,i)=>{
            ...
            t.data.datasets.forEach(((e,o)=>{
                ...
                let {start: h, count: d} = function(t, e) {
                    ...
                    return l && (o = Ht(se(e, s.axis, a).lo, 0, i - 1)),
    ...
    function es(t, e, i) {
        ...
        !(o === e || o < 0 || o >= i) && o) : ["origin", "start", "end", "stack", "shape"].indexOf(n) >= 0 && n
    }
    class is {
        constructor(t) {
            this.x = t.x,
    ...
    var bs = {
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < n; ++a)
                l = o[a],
                l && !1 !== l.fill && (l.fill = hs(o, a, i.propagate))
        },
        beforeDraw(t, e, i) {
    ...
    class ys extends Mn {
        ...
        _draw() {
            ...
            t.legendItems.forEach(((M,k)=>{
                a.strokeStyle = M.fontColor || u,
                a.fillStyle = M.fontColor || u;
                ...
                let C = m.x
                  , O = m.y;
                h.setWidth(t.width),
                y ? k > 0 && C + D + f > t.right && (O = m.y += w,
                m.line++,
                C = m.x = o(r, t.left + f, t.right - n[m.line])) : k > 0 && O + w > t.bottom && (C = m.x = C + i[m.line].width + f,
                m.line++,
                ...
                !function(t, e, i) {
                    ...
                    l.usePointStyle) {
                        ...
                        const o = e + Math.max((g - b) / 2, 0)
                          ...
                          , r = Fe(i.borderRadius);
                        a.beginPath(),
                        Object.values(r).some((t=>0 !== t)) ? ne(a, {
                            x: s,
                            y: o,
                            w: x,
                            h: b,
        ...
        _drawColorBox(t, e, i, n, o) {
            ...
            if (o.usePointStyle) {
                ...
                const e = n.leftForLtr(u, c)
                  ...
                  , s = Fe(a.borderRadius);
                Object.values(s).some((t=>0 !== t)) ? (t.beginPath(),
                t.fillStyle = o.multiKeyBackground,
                ne(t, {
                    x: e,
                    y: g,
    ...
    class js extends En {
        ...
        handleTickRangeOptions() {
            ...
            if (o === s) {
                let t = 1;
                (s >= Number.MAX_SAFE_INTEGER || o <= Number.MIN_SAFE_INTEGER) && (t = Math.abs(.05 * s)),
                r(s + t),
                e || a(o - t)
            }
            t.min = o,
        ...
        buildTicks() {
            ...
            const o = function(t, e) {
                ...
                $(r) || (y = Math.pow(10, r),
                k = Math.ceil(k * y) / y),
                "ticks" === n ? (v = Math.floor(g / k) * k,
                w = Math.ceil(p / k) * k) : (v = g,
                w = p),
                m && x && o && Lt((a - s) / o, k / 1e3) ? (M = Math.round(Math.min((a - s) / k, c)),
                k = (a - s) / M,
                v = s,
                w = a) : b ? (v = m ? s : v,
                w = x ? a : w,
                M = l - 1,
                k = (w - v) / M) : (M = (w - v) / k,
                M = At(M, Math.round(M), k / 1e3) ? Math.round(M) : Math.ceil(M));
                ...
                v < s && P++,
                At(Math.round((v + P * k) * y) / y, s, Hs(s, _, t)) && P++) : v < s && P++); P < M; ++P)
                    i.push({
            ...
            return "ticks" === e.bounds && Rt(o, t, "value"),
            e.reverse ? (o.reverse(),
            t.start = t.max,
    ...
    class Us extends En {
        ...
        buildTicks() {
            ...
            return "ticks" === e.bounds && Rt(i, t, "value"),
            e.reverse ? (i.reverse(),
            t.start = t.max,
            t.end = t.min) : (t.start = t.min,
            t.end = t.max),
        ...
        getPixelForValue(t) {
            ...
            null === t || isNaN(t) ? NaN : e.getPixelForDecimal(t === e.min ? 0 : (Pt(t) - e._startValue) / e._valueRange)
        }
        getValueForPixel(t) {
            const e = this
    ...
    function Js(t, e, i, n) {
        const {ctx: o} = t;
        if (i)
            o.arc(t.xCenter, t.yCenter, e, 0, _t);
        else {
    ...
    class ea extends js {
        ...
        drawBackground() {
            ...
            if (e) {
                ...
                n.save(),
                n.beginPath(),
                Js(t, t.getDistanceFromCenterForValue(t._endValue), i, t.getLabels().length),
                n.closePath(),
                n.fillStyle = e,
                n.fill(),
                n.restore()
    ...
    function sa(t, e) {
        ...
        null === a ? null : (o && (a = "week" !== o || !Tt(s) && !0 !== s ? i.startOf(a, o) : i.startOf(a, "isoWeek", s)),
        +a)
    }
    function aa(t, e, i, n) {
        const o = na.length;
    ...
    class ca extends En {
        ...
        _generate() {
            ...
            u++)
                ra(h, d, g);
            return d !== n && "ticks" !== o.bounds && 1 !== u || ra(h, d, g),
    ...
    function ha(t, e, i) {
        let n, o, s, a, r = 0, l = t.length - 1;
        i ? (e >= t[r].pos && e <= t[l].pos && ({lo: r, hi: l} = se(t, "pos", e)),
        ({pos: n, time: s} = t[r]),
        ({pos: o, time: a} = t[l])) : (e >= t[r].time && e <= t[l].time && ({lo: r, hi: l} = se(t, "time", e)),
        ({time: n, pos: s} = t[r]),
        ({time: o, pos: a} = t[l]));
        const c = o - n;
    ...
    return oo.register(Po, ua, Zo, Vs),
    oo.helpers = {
        ...Ni
    },
    oo._adapters = co,
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label: a=>{
                            ...
                            return a.parsed.y !== null && (b += " : " + a.parsed.y + "%"),
                            b
                        }
                    }
                }
            ...
            plugins: {
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label: a=>{
                            let b = a.dataset.label || "";
                            return a.parsed.y !== null && (b += " : $" + a.parsed.y + ".00"),
                            b
                        }
                    }
                }
            ...
            plugins: {
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label: a=>{
                            let b = a.dataset.label || "";
                            return a.parsed.y !== null && (b += ` ${a.parsed.y} Sales`),
                            b
                        }
                    }
                }
            ...
            plugins: {
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label: a=>{
                            let b = a.dataset.label || "";
                            return a.parsed.x !== null && (b += " " + a.parsed.x + " Items Completed"),
                            b
                        }
                    }
                }
